...
function MTMakeSubmenu(menu, isExpanded, collapseIcon, expandIcon) {
	...
	this.collapseIcon = collapseIcon ? collapseIcon : "../code/menu-images/menu_folder_closed.gif";
	this.expandIcon = expandIcon ? expandIcon : "../code/menu-images/menu_folder_open.gif";
...
var MTMenuText = "Site contents:", MTMRootIcon = "../code/menu-images/menu_new_root.gif", MTMRootColor = "#000000";
...
function MTMDisplayItem(item, last) {
	...
	if(MTMLevel > 0) {
		for (i = 0; i < MTMLevel; i++) {
			MTMOutputString += (MTMBar[i]) ? MTMakeImage("../code/menu-images/menu_bar.gif") : MTMakeImage("../code/menu-images/menu_pixel.gif");
		}
	}
	...
	if(item.submenu && usePlusMinus) {
		...
		if(item.expanded) {
			img = (last) ? "../code/menu-images/menu_corner_minus.gif" : "../code/menu-images/menu_tee_minus.gif";
		} else {
			img = (last) ? "../code/menu-images/menu_corner_plus.gif" : "../code/menu-images/menu_tee_plus.gif";
		}
	  // Else condition added by Saurabh on 5/19
	} 
		...
		img = (last) ? "../code/menu-images/menu_corner.gif" : "../code/menu-images/menu_tee.gif";
	}
	
	// End of changes, previously there was just else statement
...
function MTMFetchIcon(testString) {
	...
	return("../code/menu-images/menu_link_default.gif");
}
